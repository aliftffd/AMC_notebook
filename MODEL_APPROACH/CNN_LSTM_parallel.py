...
class CNN_LSTM_Parallel(nn.Module):
    def __init__(self, 
                 ...
                 cnn_filters=[16, 32, 64],  # Reduced from [32, 64, 128] for 4GB VRAM
                 lstm_hidden_dim=32,    # Reduced from 64 to 32 for memory efficiency
                 lstm_num_layers=1,     # Reduced from 2 to 1 for memory efficiency
                 dropout=0.3,
